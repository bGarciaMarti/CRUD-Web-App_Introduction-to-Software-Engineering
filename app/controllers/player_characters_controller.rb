class PlayerCharactersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @player_character.save
        format.html { redirect_to player_character_url(@player_character), notice: "Player character was successfully created." }
  ...
  def update
    respond_to do |format|
      if @player_character.update(player_character_params)
        format.html { redirect_to player_character_url(@player_character), notice: "Player character was successfully updated." }
  ...
  private
    ...
    def player_character_params
      params.require(:player_character).permit(:name, :main_stats, :proficiency, :saving_throws)
    end
end
